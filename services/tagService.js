...
import 'dotenv/config'; //import dotenv from "dotenv"; dotenv.config();를 줄여서 쓸수있음

// OpenAI 셋팅
    const openai = new OpenAI({apiKey : process.env.OPENAI_API_KEY}); // import했던 openAI 생성
...
**예시:**
게시글: 오늘 새벽에 일어나서 혼자 한강을 걸었는데.. 정말 조용하고 평화로웠어요
출력: 새벽산책,힐링,평화로움

게시글: 상사에게 혼나고 하루 종일 기운이 빠졌어요. 자존감이 바닥을 치는 것 같아 너무 괴롭네요
출력: 직장스트레스,우울,자존감

게시글: 친구들과 오랜만에 맛있는 저녁을 먹으며 수다 떨고 웃었던 행복한 밤이었어요
출력: 친구모임,행복,즐거움`,
   },
   {
     role: "user",
